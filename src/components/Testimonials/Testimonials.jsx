...
const testimonials = [
  { id: 1, name: "Sarah Johnson", role: "Marketing Director, TechCorp", content: "Working with NOVA4MEDIA transformed our brand presence. Their creative vision and attention to detail are unmatched.", avatar: "https://images.unsplash.com/photo-1494790108755-2616b612b786?w=400&auto=format&fit=crop" },
  { id: 2, name: "David Lee", role: "CEO, StartupHub", content: "The team brought our ideas to life with professionalism and creativity. Highly recommended!", avatar: "https://images.unsplash.com/photo-1502767089025-6572583495f1?w=400&auto=format&fit=crop" },
  { id: 3, name: "Emily Carter", role: "Creative Lead, BrandWorks", content: "Their attention to detail and aesthetic sense made all the difference in our project.", avatar: "https://images.unsplash.com/photo-1544723795-3fb6469f5b39?w=400&auto=format&fit=crop" },
];
...
const TestimonialsSection = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      if (!isHovered) setCurrentIndex((prev) => (prev + 1) % testimonials.length);
    }, 5000);
  ...
  return (
    ...
    >
      ...
      <div className="floating-elements-testimonials">
        ...
        <div className="testimonials-main">
          <div className="testimonial-featured">
            ...
            <div className="testimonial-user-large">
              <img src={currentTestimonial.avatar} alt={currentTestimonial.name} className="testimonial-avatar-large" />
              <div>
